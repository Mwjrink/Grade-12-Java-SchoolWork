...
public class Account {
	...
	/**
	 * constructor pre: none post: An account has been created. Balance and
	 * customer data has been initialized with parameters.
	 */
	public Account(double bal, String fName, String lName, String Address) {
		balance = bal;
	...
	/**
	 * constructor pre: none post: An empty account has been created with the
	...
	/**
	 * Returns the account ID. pre: none post: The account ID has been returned.
	 */
	public String getID() {
		return (acctID);
	}
	...
	/**
	 * Returns a true when objects have matching account IDs. pre: none post:
	 * true has been returned when the objects are equal, false returned
	 * otherwise.
	 */
